...
@XmlRootElement(name = "FareRefreshAugPoint")
public class FareRefreshAugPoint {

    @XmlElement(name = "IsFareRefreshRequired")
    protected Boolean isFareRefreshRequired;

    /**
     * Gets the value of the isFareRefreshRequired property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the isFareRefreshRequired property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
