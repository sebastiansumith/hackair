...
@XmlSeeAlso({
    ...
    org.iata.iata.edist.OrderListRQ.Query.Filters.Passengers.FOID.class,
    org.iata.iata.edist.OrderListRQ.Query.Filters.Payments.Method.class,
    ...
    org.iata.iata.edist.BaggageChargesRQ.TicketIdentification.class,
    ItineraryType.class,
    ProcessingResultType.class,
    org.iata.iata.edist.ItinReshopRQ.Query.Reshop.Actions.OfferItemSets.OfferItemSet.class,
    ...
    org.iata.iata.edist.OrderRetrieveRQ.Query.Filters.Passengers.FOID.class,
    org.iata.iata.edist.OrderRetrieveRQ.Query.Filters.Payments.Method.class,
    ...
    org.iata.iata.edist.Warnings.Warning.class,
    ...
    org.iata.iata.edist.CarryOnAllowanceType.CarryOnBag.class,
    FQTVProgramCoreType.class,
    org.iata.iata.edist.QualifiersType.Qualifier.class,
    AirlineOffersSnapshotType.class,
    org.iata.iata.edist.PaymentForms.PaymentForm.class,
    SeatComponentType.class,
    org.iata.iata.edist.FareRulesRemarks.FareRulesRemark.class,
    org.iata.iata.edist.PassengerSummaryType.FQTVs.class,
    org.iata.iata.edist.CheckedBagAllowanceType.CheckedBag.class,
    ServiceFulfillmentType.class,
    org.iata.iata.edist.PaymentMethodType.Method.class,
    ServiceCoreType.class,
    FareRulesType.class,
    FltArriveQualifiedQueryType.class,
    SpecialType.class,
    SeatMapMessageType.class,
    org.iata.iata.edist.OrderPaymentMethodType.Method.class,
    OrderCoreType.class,
    ...
    org.iata.iata.edist.OrderItemCoreType.OrderItem.class,
    ...
    org.iata.iata.edist.OfferItemTimeLimitSetType.TimeLimit.class,
    OfferItemCoreType.class,
    FlightItemOfferType.class,
    RuleSetType.class,
    org.iata.iata.edist.OrdCreateNoticesType.PriceVarianceRules.PriceVarianceRule.class,
    org.iata.iata.edist.OrdChangeNoticesType.PriceVarianceRules.PriceVarianceRule.class,
    MarketingInfoType.class,
    OrderPaymentFormType.class,
    OfferTermsType.class,
    org.iata.iata.edist.ProcessingErrorType.Error.class,
    FlightOnlyType.class,
    org.iata.iata.edist.OrderItemRepriceType.OrderItem.class,
    DiscountType.class,
    TaxCoreType.class,
    ...
    PenaltyType.class,
    org.iata.iata.edist.OfferIncentiveType.Incentive.class,
